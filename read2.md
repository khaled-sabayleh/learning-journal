...
its apeace of software to write and manage text .
...
the most features is code complications .



Using The Software That Already
Comes With Your Computer .
the name of exeditor in our windows called : notepode
so important to : please make sure that when you’re saving your file, that they
